...
EXTEND_BOTTOM CECHALLE 4
  IF ~Global("CerndChallenge","GLOBAL",0) Global("PlayerHasStronghold","GLOBAL",0)~ THEN DO ~SetGlobal("SPRITE_IS_DEADFaldorn","GLOBAL",1) SetGlobal("SPRITE_IS_DEADcefaldor","GLOBAL",1) SetNumTimesTalkedTo(1)~ GOTO CDDruidChoice
END
...
EXTEND_BOTTOM RAELIS 71
  IF ~~ THEN GOTO CDRewardChoiceRaelis
END

EXTEND_BOTTOM HAERDA 99
  IF ~~ THEN EXTERN RAELIS CDRewardChoiceRaelis2
END
